...
class AuthService extends React.Component {
  ...
  putDeviceToken(token) {
    ...
    fetch('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/addDeviceToken', {
      method: 'PUT',
      headers: {
  ...
  connectToSocket() {
    ...
    socket = io('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000');
  ...
  postMessage(message) {
    ...
    fetch('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/messages', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  guardPut(loggedIn) {
    ...
    fetch('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/guards', {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  patrolPost() {
    ...
    fetch('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/patrols', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  coordPut() {
    ...
    fetch('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/coordinates', {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  coordDelete(patrolID) {
    ...
    fetch('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/coordinates/' + patrolID, {
      method: 'DELETE',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  routePut() {
    ...
    fetch('http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/queueroute', {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
