...
<module external.linked.project.id=":react-native-push-notification" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" external.system.module.group="piggi" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="com.android.support:appcompat-v7-23.1.1" level="project" />
    ...
    <orderEntry type="library" name="me.leolin:ShortcutBadger-1.1.8" level="project" />
