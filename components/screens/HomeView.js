...
class HomeView extends React.Component {
  ...
  loadCurrentRoutes() {
    ...
    fetch('http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/currentroutes/' + this.idService.getCurrentGuardID())
      .then(res => res.json())
      .then(json => {
  ...
  loadCurrentCheckpoints(routeID) {
    ...
    fetch('http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/checkpoints/' + routeID)
      .then(res => res.json())
      .then(json => {
