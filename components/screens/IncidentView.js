...
class IncidentView extends React.Component {
  ...
  onPressSubmitButton() {
    ...
    fetch('http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/incidents', {
      method: 'POST',
      headers: {
  ...
  fetchPresignUrl(fileName) {
    ...
    xhr.open("GET", 'http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:8080/getPreSignUrl?fileName=' + fileName, true);
